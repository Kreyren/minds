<?php
/**
 * Core Czech Language - NOT FINISHED
 * This translation is made with 100% translation from czech to english.
 * It is NOT recommended to use this translation for developers since czech translation for tech terms is missleading and wrong.
 *
 * @package Elgg.Core
 * @subpackage Languages.English
 * Translated by Kreyren (https://github.com/Kreyren)
 */
$czech = array(
/**
 * Sites
 ...
 */
	'login' => "Přihlásit",
	'loginok' => "Byl jste přihlášen.",
	'loginerror' => "Nemohli jsme Vás přihlásit, Zkontrolujte svoje přihlašovací údaje.",
	'login:empty' => "Uživatelské jméno a heslo je nutné k přihlášení.",
	'login:baduser' => "Nemohli jsme nahrát Vás účet.",
	'auth:nopams' => "Internal error. Žádná metoda autentifikace není nainstalována.",
	'logout' => "Odhlásit",
	'logoutok' => "Byl jste odhlášen.",
	'logouterror' => "Odhlášení se nepodařilo, Zkuste to prosím znovu.",
	'loggedinrequired' => "K zobrazení této stránky se musíte přihlásit.",
	'adminrequired' => "Jen administrátoři mají přístup k této stránce.",
/** SUGGESTION: Something like $GROUP which outputs the name of the group should be added. **/
	'membershiprequired' => "Jen členové dané skupiny mají přistup k zobrazení této stránky.",
/**
 * Errors / Chybové hlášky
 */
	'exception:title' => "Fatální Error.",
/** SUGGESTION: Contact on admin should be provided if it's not already. **/
	'exception:contact_admin' => 'Byl zaznamenán neočekávaný error, kontaktujte administratora s následujícími informacemi:',
	'actionundefined' => "Požadovaná akce (%s) není definována v systému.",
/** Shorted it to make sence in czech. Action file has terrible translate in Akční soubor/Soubor akce which sounds like something from rambo.. **/ 
	'actionnotfound' => "%s nebyl nalezen.",
	'actionloggedout' => "Tuto akci nemůžete provést pokud jste odhlášen.",
	'actionunauthorized' => 'Nemáte dostatečné pravomoce k této akci',
	'InstallationException:SiteNotInstalled' => 'Tato žádost nemohla být předána, protože stránka '
		. ' není nakonfigurována či databáse je offline.',
	'InstallationException:MissingLibrary' => 'Soubor %s nebyl nalezen.',
	'InstallationException:CannotLoadSettings' => 'Elgg nemohl načíst konfigurační soubor. Soubor neexistuje a nebo na něj nemáte pravomoce.',
	'SecurityException:Codeblock' => "Žádost o spuštění této části kódu byla zamítnuta.",
	'DatabaseException:WrongCredentials' => "Elgg se nemohl připojit do databáze s těmito údaji. Zkontrolujte konfigurační soubor.",
	'DatabaseException:NoConnect' => "Elgg nemohl zvolit databázi '%s', zkontrolujte zda databáze existuje a zda na ní máte pravomoce.",
	'SecurityException:FunctionDenied' => "Přístup k funkci '%s' není povolen.",
	'DatabaseException:DBSetupIssues' => "Bylo tu několik problémů: ",
	'DatabaseException:ScriptNotFound' => "Elgg nemohl najít požadavaný script databáze na %s.",
/** added "(query)" for czech developers to understand the error message. Usage of "dotaz" is not affiliated with "Query" even when it's the correct translation. **/
	'DatabaseException:InvalidQuery' => "Neplatný dotaz (query)",
	'DatabaseException:InvalidDBLink' => "Připojení k databázi bylo ztraceno.",
	'IOException:FailedToLoadGUID' => "Nahrání %s z GUID:%d selhalo.",
	'InvalidParameterException:NonElggObject' => "Vkládání non-ElggObject do ElggObject kompositoru!",
	'InvalidParameterException:UnrecognisedValue' => "Neplatná hodnota vložena do kompositoru.",
	'InvalidClassException:NotValidElggStar' => "GUID:%d není platný %s",
	'PluginException:MisconfiguredPlugin' => "%s (guid: %s) je špatně nakonfigurovaný plugin a proto byl deaktivován. Odkazte se na Elgg wiki pro více informací (http://docs.elgg.org/wiki/).",
	'PluginException:CannotStart' => '%s (guid: %s) nemohl být spuštěn a proto byl deaktivován.  Důvod: %s',
	'PluginException:InvalidID' => "%s je neplatné ID pluginu .",
	'PluginException:InvalidPath' => "%s je neplatná cesta k pluginu.",
	'PluginException:InvalidManifest' => 'Neplatní manifest pro plugin %s',
	'PluginException:InvalidPlugin' => '%s není platný plugin.',
	'PluginException:InvalidPlugin:Details' => '%s není platný plugin: %s',
	'PluginException:NullInstantiated' => 'ElggPlugin nemůže být null. Musíte vložit GUID, a plugin ID, nebo úplnou cestu k souboru.',
	'ElggPlugin:MissingID' => 'Chybí plugin ID (guid %s)',
	'ElggPlugin:NoPluginPackagePackage' => 'Chybí ElggPluginPackage pro plugin ID %s (guid %s)',
	'ElggPluginPackage:InvalidPlugin:MissingFile' => 'Požadovaný soubor "%s" chybí.',
	'ElggPluginPackage:InvalidPlugin:InvalidDependency' => 'Manifest obsahuje neplatnou závyslost "%s".',
	'ElggPluginPackage:InvalidPlugin:InvalidProvides' => 'Manifest obsahuje neplatného poskytovatele "%s".',
	'ElggPluginPackage:InvalidPlugin:CircularDep' => '%s je neplatná závyslost "%s" v pluginu %s. Plugin nemůže odporovat či být v rosporu s něčím co sám obsahuje!',
	'ElggPlugin:Exception:CannotIncludeFile' => 'Nemůže pojmout %s pro plugin %s (guid: %s) v %s.',
	'ElggPlugin:Exception:CannotRegisterViews' => 'Soubor se zhlednutím pro plugin %s (guid: %s) v %s nemůže být zahrnut.',
	'ElggPlugin:Exception:CannotRegisterLanguages' => 'Překlad pro plugin %s (guid: %s) v %s nemůže být registrován.',
	'ElggPlugin:Exception:NoID' => 'ID pro plugin a guid %s nebylo nalezeno!',
	'PluginException:ParserError' => 'Chyba vkládání manifestu s API verzí %s do pluginu %s.',
	'PluginException:NoAvailableParser' => 'Vkládač pro manifest API verzi %s v pluginu %s nemohl být nalezen.',
	'PluginException:ParserErrorMissingRequiredAttribute' => "Chybí požadavaný atribut '%s' atribut manifestu pro plugin %s.",
	'ElggPlugin:Dependencies:Requires' => 'Požaduje',
	'ElggPlugin:Dependencies:Suggests' => 'Navrhuje',
	'ElggPlugin:Dependencies:Conflicts' => 'Odporuje',
	'ElggPlugin:Dependencies:Conflicted' => 'Odporoval',
	'ElggPlugin:Dependencies:Provides' => 'Poskytuje',
	'ElggPlugin:Dependencies:Priority' => 'Prioritizuje',
	'ElggPlugin:Dependencies:Elgg' => 'Elgg verze',
	'ElggPlugin:Dependencies:PhpExtension' => 'PHP koncovka: %s',
	'ElggPlugin:Dependencies:PhpIni' => 'PHP ini configurace: %s',
	'ElggPlugin:Dependencies:Plugin' => 'Plugin: %s',
	'ElggPlugin:Dependencies:Priority:After' => 'Po %s',
	'ElggPlugin:Dependencies:Priority:Before' => 'Před %s',
	'ElggPlugin:Dependencies:Priority:Uninstalled' => '%s není nainstalován',
	'ElggPlugin:Dependencies:Suggests:Unsatisfied' => 'Chybí',
	'ElggPlugin:InvalidAndDeactivated' => '%s není platný plugin a proto byl deaktivován.',
	'InvalidParameterException:NonElggUser' => "Vkládání non-ElggUser do ElggUser konstraktoru!",
	'InvalidParameterException:NonElggSite' => "Vkládání non-ElggSite do ElggSite konstraktoru!",
	'InvalidParameterException:NonElggGroup' => "Vkládání a non-ElggGroup do ElggGroup konstraktoru!",
	'IOException:UnableToSaveNew' => "Nepodařilo se uložit nový %s",
	'InvalidParameterException:GUIDNotForExport' => "GUID nebylo nakonfigurováno během exportu, tohle by se nikdy nemělo stát.",
	'InvalidParameterException:NonArrayReturnValue' => "Entita serializační funkce vložila neřádkový vratný parametr",
	'ConfigurationException:NoCachePath' => "Chybí cesta k mezipaměti!",
	'IOException:NotDirectory' => "%s není složka.",
	'IOException:BaseEntitySaveFailed' => "Nepodařila se uložit základní informace entity nového objektu!",
	'InvalidParameterException:UnexpectedODDClass' => "import() vložil nepředvídatelnou ODD třídu",
	'InvalidParameterException:EntityTypeNotSet' => "Typ entity musí být zvolen.",
	'ClassException:ClassnameNotClass' => "%s není to samé jako %s.",
	'ClassNotFoundException:MissingClass' => "Třída '%s' nebyla nalezena, plugin chybí?",
	'InstallationException:TypeNotSupported' => "Typ %s není podporován. Toto napovídá chybě Vaší instalace, pravděpodobně způsobená nekompletním vylepšením.",
	'ImportException:ImportFailed' => "Element %d nemohl být vložen",
	'ImportException:ProblemSaving' => "Při ukládání %s došlo k chybě.",
	'ImportException:NoGUID' => "Nová entita byla vytvořena bez GUID, tohle by se nemělo stát.",
	'ImportException:GUIDNotFound' => "Entita '%d' nemůže být nalezena.",
	'ImportException:ProblemUpdatingMeta' => "Vyskytl se problém s aktualizací '%s' entity '%d'",
	'ExportException:NoSuchEntity' => "Tato entita neexistuje GUID:%d",
	'ImportException:NoODDElements' => "OpenDD element nebyl nalezen ve vložených dat, vkládání selhalo.",
	'ImportException:NotAllImported' => "Všechny elementy nebyli vloženy.",
	'InvalidParameterException:UnrecognisedFileMode' => "Mod souboru '%s' nebyl rozpoznán.",
	'InvalidParameterException:MissingOwner' => "Souboru %s (souboru guid:%d) (majitele guid:%d) chybí majitel!",
	'IOException:CouldNotMake' => "%s nemohl být vytvoře",
	'IOException:MissingFileName' => "Musíte uvést jméno před otevřením souboru.",
	'ClassNotFoundException:NotFoundNotSavedWithFile' => "Nepodařilo se načíst uložiště třídy %s pro soubor %u",
	'NotificationException:NoNotificationMethod' => "Metoda pro notifikace nebyla specifikována.",
	'NotificationException:NoHandlerFound' => "Žádný manipulator pro '%s' nebyl nelezen a nebo nebyl vyměnitelný.",
	'NotificationException:ErrorNotifyingGuid' => "Vyskytla se chyba během notifikace pro %d.",
	'NotificationException:NoEmailAddress' => "Nelze získat e-mail pro GUID:%d",
	'NotificationException:MissingParameter' => "Chybí požadovaný parametr, '%s'",
/** Not sure about this one **/
	'DatabaseException:WhereSetNonQuery' => "kde nastavení obsahuje WhereQueryComponent",
