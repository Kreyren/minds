<?php
/**
 * Czech Language optimized for the usage on minds
 * Created translation which uses Czech+english words which are more understandable for the czech citizen.
 * SUGGESTION: Czech utilizes gender in its language. The translation should be adjusted based on gender that user provided. 
 *
 * @package Elgg.Core
 * @subpackage Languages.English
 */
$czech_optimized = array(
/**
 * Sites
 */
	'item:site' => 'Sítě',
 ...
 */
	...
	'loginerror' => "Přihlášení se nezdařilo, zkontrolujte přihlašovací údaje.",
	'login:empty' => "Nevyplnil jste přihlašovací údaje.",
	'login:baduser' => "Načítání Vašého účtu se nezdařilo.",
	'auth:nopams' => "Internal error. No user authentication method installed.",
	'logout' => "Odhlásit",
	'logoutok' => "Byl jste odhlášen.",
	'logouterror' => "Odhlášení se nezdařilo, prosím zkuste to znovu.",
	'loggedinrequired' => "Musíte být přihlášen k zobrazení tohoto obsahu.",
	'adminrequired' => "Musíte být administratorem k zobrazení této obsahu.",
	'membershiprequired' => "k zobrazení tohoto obsahu musíte být členem dané skupiny.",
/**
 * Errors
 * Errors won't be translated since translation is making them missleading. 
 * If translation is attempted then phrases should be defined here first alike "soubor" == "file", "directory" == "složka", etc.. to prevent translation issues.
 */
 ...
 */
	...
	'admin_option' => "Je tento uživatel administrator?",
/**
 * Access
 */
	'PRIVATE' => "Soukromé",
	...
	'access' => "Přístup",
	'access:limited:label' => "Omezeno",
/** TODO: context? **/
	'access:help' => "The access level",
/**
 * Dashboard and widgets
 */
/** Used aktivita because it sounds better.. **/
	'dashboard' => "Aktivita",
	'dashboard:nowidgets' => "Záložka aktivita Vám umožní sledovat aktivitu lidí, které odebíráte.",
	'widgets:add' => 'Přidat widgety',
	'widgets:add:description' => "Click on any widget button below to add it to the page.",
	'widgets:position:fixed' => '(Fixed position on page)',
	'widget:unavailable' => 'Tento widget jste už přidal',
	'widget:numbertodisplay' => 'Number of items to display',
	'widget:delete' => 'Odstranit %s',
	'widget:edit' => 'Přizpůsobit widget',
	'widgets' => "Widgety",
	'widget' => "Widget",
 ...
 */
	...
	/** TODO: Should be updated once minds can differentiate user gender in its translation. **/
	'friends:owned' => "Přátelé uživatele %s",
	'friend:add' => "Přidat přátele",
	'friend:remove' => "Odebrat přátele",
	...
	'friends:none:you' => "Zatím nemáš žádné kamarády.",
 ...
 * Notifications
 */
	'notifications:usersettings' => "Nastavení notifikací",
...
add_translation("cs_improved",$czech_improved);
