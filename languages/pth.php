 ...
 */
	'login' => "QonoS",
	'loginok' => "QonoS SoH.",
	'loginerror' => "SoH couldn't QonoS maH. nuqneH credentials check 'ej yInIDqa'.",
	'login:empty' => "username 'ej mu'wIj poQlu'.",
	'login:baduser' => "unable account user load.",
	'auth:nopams' => "internal Qagh. pagh user authentication method jom.",
	'logout' => "QonoS",
	'logoutok' => "QonoS SoH 'e' yIQoy.",
	'logouterror' => "SoH couldn't QonoS maH. DubelmoHchugh yInIDqa'.",
	'loggedinrequired' => "ghob'e' QonoS SoH page jIH.",
	'adminrequired' => "ghob'e' administrator page jIH.",
	'membershiprequired' => "ghob'e' member ghom jIH page.",
/**
 * Errors
 */
	'exception:title' => "HeghmoH Qagh.",
	'exception:contact_admin' => "qaS 'ej QonoS Qagh unrecoverable. Daq administrator je tlha' De' contact:",
	'actionundefined' => "wej defined request action (vatlhvI' s) neH pat.",
	'actionnotfound' => "wej tu' action teywI' %s.",
	'actionloggedout' => "jIQoS, action poStaHvIS QonoS pagh much SoH.",
	'actionunauthorized' => ', unauthorize action much',
	'InstallationException:SiteNotInstalled' => "unable request DeS. Daq
		. wej configured pagh database vI'ogh.",
	'InstallationException:MissingLibrary' => 'laH wej load %s',
	'InstallationException:CannotLoadSettings' => "settings teywI' laH wej load elgg. wej nIv'e' 'oH pagh teywI' choHwI' wIlIng wanI'vammo' tlha' tu'lu'.",
	'SecurityException:Codeblock' => "naw' DIb ngoq bot muH tem",
	'DatabaseException:WrongCredentials' => "couldn't rar elgg database nob credentials lo'. settings teywI' check.",
	'DatabaseException:NoConnect' => "couldn't vatlhvI' s database wIv, check 'e' chenmoH database 'ej naw' Daghaj bel elgg.",
	'SecurityException:FunctionDenied' => "tem naw' DIb Qap vatlhvI' s.",
	'DatabaseException:DBSetupIssues' => "wanI'vammo' tlha' mI' tu'lu': ",
	'DatabaseException:ScriptNotFound' => "request database script couldn't tu' elgg DeSDu' vatlhvI' %s.",
	'DatabaseException:InvalidQuery' => "Invalid query",
	'DatabaseException:InvalidDBLink' => "luj connection database.",
	'IOException:FailedToLoadGUID' => "chu' %s vo' load luj GUID:%d",
	'InvalidParameterException:NonElggObject' => "QI'yaH-elggobject ghoS constructor elggobject nganpu'.!",
	'InvalidParameterException:UnrecognisedValue' => "juS lo'laHghach unrecognise constuctor.",
	'InvalidClassException:NotValidElggStar' => "GUID:%d 'oHbe' valid %s",
	'PluginException:MisconfiguredPlugin' => "%s (guid: %s) misconfigure plugin. Qotlh 'oH. nuqneH elgg wiki qIt Hegh'e' search (http://docs.elgg.org/wiki/).",
	'PluginException:CannotStart' => "%s (guid: %s) pagh start 'ej yIchu'Ha'.  mo': %s",
	'PluginException:InvalidID' => "%s invalid plugin id",
	'PluginException:InvalidPath' => "%s path invalid plugin.",
	'PluginException:InvalidManifest' => "invalid manifest teywI' plugin %s",
	'PluginException:InvalidPlugin' => "%s 'oHbe' valid plugin.",
	'PluginException:InvalidPlugin:Details' => "%s 'oHbe' valid plugin: %s",
	'PluginException:NullInstantiated' => "elggplugin pagh null instantiated. guid, plugin id, path naQ joq ghob'e' juS SoH.",
	'ElggPlugin:MissingID' => 'plugin id missing (guid %s)',
	'ElggPlugin:NoPluginPackagePackage' => 'elggpluginpackage missing plugin id %s (guid %s)',
	'ElggPluginPackage:InvalidPlugin:MissingFile' => "poQ teywI' %s missing.",
	'ElggPluginPackage:InvalidPlugin:InvalidDependency' => 'Segh invalid dependency ngaS manifest "%s".',
	'ElggPluginPackage:InvalidPlugin:InvalidProvides' => "invalid Sev manifest Segh DuHIvDI '%s'.",
	'ElggPluginPackage:InvalidPlugin:CircularDep' => "invalid %s dependency %s tu'lu' qaStaHvIS plugin vatlhvI' s.  pagh yol pagh vay' DuHIvDI' chaH poQ plugins!",
	'ElggPlugin:Exception:CannotIncludeFile' => 'pagh %s plugin DaH nobvam %s (guid: %s) legh %s.',
	'ElggPlugin:Exception:CannotRegisterViews' => 'pagh, jIH dir plugin poS %s (guid: %s) legh %s.',
	'ElggPlugin:Exception:CannotRegisterLanguages' => 'pagh Hol plugin Suy qachmey %s (guid: %s) legh %s.',
	'ElggPlugin:Exception:NoID' => 'plugin guid id pagh %s!',
	'PluginException:ParserError' => "Qagh parsing manifest api version bIr mIw wIje'laHbe'chugh vaj %s neH plugin %s.",
	'PluginException:NoAvailableParser' => "pagh parser tu' manifest api version %s qaStaHvIS plugin  %s.",
...
add_translation("pth",$paramountHol);
